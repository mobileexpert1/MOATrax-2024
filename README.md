...
let baseUrl = "https://services.myoutdooragent.com/api/"
...
### realm/SwiftLint
A tool to enforce Swift style and conventions, loosely based on the now archived GitHub Swift Style Guide. [SwiftLint][swiftLint-github] enforces the style guide rules that are generally accepted by the Swift community. These rules are well described in popular style guides like Ray Wenderlich's Swift Style Guide.
...
### GeoTiffDecoder
Custom made library to transform the geopdf projection data

## Architecture

* [Model-View-Controller (MVC)][mvc]
    * This is the default Apple architecture (MVC).
    * Standard MVC pattern recommended by Apple. Uses composition design pattern to make ViewController smaller.

[mvc]: https://github.com/ayushP2400/MVC-iOS
